...
try:
    if not API_KEY:
        # Optional: allow bundling key in app_secrets.py within the APK
        from app_secrets import API_KEY as _APP_API_KEY  # type: ignore
...
# Data directory for saving various data (overridable via env)
