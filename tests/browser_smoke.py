...
def main() -> None:
    with sync_playwright() as playwright:
        ...
        evidence = page.locator(".graph-evidence-panel")
        evidence.get_by_text("draftkings", exact=True).wait_for()
        evidence.get_by_text("fanduel", exact=True).wait_for()
        ...
        page.locator("#detailsBody").get_by_text("draftkings", exact=True).wait_for()
